...
class Supplier extends Model
{
    ...
    public function setSupplierNameAttribute($value): void
    {
        $this->attributes['supplier_name'] = $this->toSentenceCase($value);
    }

    public function setContactNameAttribute($value): void
    {
        $this->attributes['contact_name'] = $this->toSentenceCase($value);
    }
